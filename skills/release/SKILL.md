---
name: release
description: Generic release assistant — analyzes repo release rules, caches them in .oma/RELEASE_RULE.md, then guides the release
level: 3
---

# Release Skill

A thin, repo-aware release assistant. On first run it inspects the project and CI to derive release rules, stores them in `.oma/RELEASE_RULE.md` for future use, then walks you through a release using those rules.
...
Check whether `.oma/RELEASE_RULE.md` exists.
...
Inspect the repo and answer the following. Write answers into `.oma/RELEASE_RULE.md`.
...
### Step 2 — Write `.oma/RELEASE_RULE.md`
...
- `.oma/RELEASE_RULE.md` is a local cache. Commit it to your repo if you want to share the derived rules with your team, or add it to `.gitignore` if you prefer it stays local.
